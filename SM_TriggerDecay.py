...
class Files(Prefetch):
	...
	def get_param(self):
		...
		try:
			...
			obj_ = s3_client.get_object(Bucket='augmentor-customer-data', Key='AXIADO-INTERESTS/uid.json')
			...
			s3_client.put_object(Body=json.dumps(self.__natest), Bucket = 'augmentor-customer-data', Key = 'AXIADO-INTERESTS/uid.json')
			s3_client.put_object(Body=json.dumps(self.__natest), Bucket = 'augmentor-customer-data', Key = 'AXIADO-INTERESTS/backup_uid.json')
			s3_client.put_object(Body=json.dumps(self.__decay_natest), Bucket = 'augmentor-customer-data', Key = 'AXIADO-INTERESTS/decay_uid.json')
